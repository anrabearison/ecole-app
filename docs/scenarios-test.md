...
> Il explique de manière **très claire, simple et illustrée par des exemples réels**, comment tester pas à pas l'intégralité de l'application de la création d'une école jusqu'à l'obtention du bulletin scolaire PDF.
...
2. **Les Boutons d'action** :
   ...
   - Les boutons **Blancs avec bordure** (ex: `Modifier`, `Voir`, `Retour`) permettent de consulter ou corriger.
...
4. [Test 4 : Création des Classes Physique d'Élèves](#test-4--création-des-classes-physiques-délèves)
5. [Test 5 : Création d'un Enseignant et Affectation de ses Cours](#test-5--création-dun-enseignant-et-affectation-de-ses-cours)
6. [Test 6 : Inscription d'un Élève et Nomination du Professeur Principal](#test-6--inscription-dun-élève-et-nomination-du-professeur-principal)
7. [Test 7 : Création de l'Emploi du Temps et Test Anti-Conflits](#test-7--création-de-lemploi-du-temps-et-test-anti-conflits)
8. [Test 8 : Connexion de l'Enseignant et Saisie des Notes](#test-8--connexion-de-lenseignant-et-saisie-des-notes)
9. [Test 9 : Calcul de la Moyenne, Appréciation et Délibération](#test-9--calcul-de-la-moyenne-appréciation-et-délibération)
10. [Test 10 : Génération et Téléchargement du Bulletin Scolaire PDF](#test-10--génération-et-téléchargement-du-bulletin-scolaire-pdf)
11. [Test 11 : Gestion du Profil et Changement Sécurisé du Mot de Passe](#test-11--gestion-du-profil-et-changement-sécurisé-du-mot-de-passe)
...
| Champ du formulaire | Valeur à taper / copier-coller | Explication simple |
|---|---|---|
...
2. Sur la page de connexion, tapez :
...
- Les matières enseignées et leurs coefficients.
...
#### 3. Configuration des Matières et Coefficients :
1. Menu de gauche : cliquez sur **Académique > Matières**.
2. Cliquez sur **+ Nouvelle matière** et créez :
   - Matière 1 : Nom = `Mathématiques` | Coefficient = `4.0` $\rightarrow$ Enregistrer.
   - Matière 2 : Nom = `Français` | Coefficient = `3.0` $\rightarrow$ Enregistrer.
   - Matière 3 : Nom = `Physique-Chimie` | Coefficient = `3.0` $\rightarrow$ Enregistrer.

### 🎯 Ce que vous devez observer :
- [ ] Les 2 salles apparaissent dans le tableau des salles.
- [ ] Le *Trimestre 1* affiche bien le poids Examen à 60% et Journalier à 40%.
- [ ] Les 3 matières s'affichent avec leurs coefficients respectifs (4.0, 3.0, 3.0).

---

## Test 4 : Création des Classes Physiques d'Élèves

### 🎯 Pourquoi ce test ?
Une classe réunit un groupe d'élèves pour une année scolaire donnée (ex: *6ème A*, *Première C 1*). C'est le cadre de référence pour l'emploi du temps et les bulletins.
...
## Test 5 : Création d'un Enseignant et Affectation de ses Cours
...
## Test 6 : Inscription d'un Élève et Nomination du Professeur Principal
...
## Test 7 : Création de l'Emploi du Temps et Test Anti-Conflits
...
## Test 8 : Connexion de l'Enseignant et Saisie des Notes
...
## Test 9 : Calcul de la Moyenne, Appréciation et Délibération

### 🎯 Pourquoi ce test ?
Vérifier le calcul automatique de la moyenne par l'application selon la pondération configurée, puis enregistrer l'appréciation du bulletin et la décision de passage.
...
5. Observez la moyenne affichée sous la matière Mathématiques.
...
5. Sur la page `/login`, connectez-vous avec les identifiants de l'élève :
...
## Test 11 : Gestion du Profil et Changement Sécurisé du Mot de Passe
...
* **Qui réalise ce test ?** Tout utilisateur connecté (ex: l'élève ou l'enseignant).

### 📌 Pas-à-Pas Détaillé :

#### Étape A : Accéder à son profil
1. En bas du menu de navigation à gauche, cliquez sur le bouton **Mon profil** (avec l'icône de silhouette d'utilisateur).
2. La page de gestion du profil s'ouvre avec 2 onglets :
   - **Informations personnelles**
   - **Sécurité & Mot de passe**

#### Étape B : Modifier ses informations
3. Dans l'onglet **Informations personnelles**, modifiez l'adresse email ou le numéro de téléphone.
...
6. Remplissez les 3 champs :
   - Mot de passe actuel : Tapez `MotDePasse123!`
   - Nouveau mot de passe : Tapez `MonSuperCode2026!`
   - Confirmer le nouveau mot de passe : Tapez `MonSuperCode2026!`
7. Cliquez sur **Modifier mon mot de passe**.
8. Déconnectez-vous, puis tentez de vous reconnecter avec le **nouveau mot de passe**.

### 🎯 Ce que vous devez observer :
- [ ] Une bannière verte confirme que le mot de passe a été modifié avec succès.
- [ ] La connexion avec l'ancien mot de passe est refusée.
...
Si l'ensemble des 11 tests a été réalisé et que tous les résultats attendus sont observés à l'écran, **le système informatique de gestion scolaire est totalement validé, fonctionnel et prêt pour l'exploitation en conditions réelles.**
